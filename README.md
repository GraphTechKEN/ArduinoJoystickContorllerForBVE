...
## 使い方 アナログ4入力、スイッチ16入力
> 1. アナログ入力：A0～A3が対応、ポテンショの電源端子を5V、GNDをGNDに、信号線をA0～A3に入力します。  
...
> 5. プラグインはRock_On氏が公開されている[oneHandleInputジョイスティック入力プラグイン](https://github.com/mikangogo/oneHandleInput)です。
...
> 5. [本スケッチ](https://github.com/GraphTechKEN/ArduinoJoystickContorllerForBVE/blob/main/ArduinoJoystickControllerForBVE.ino)を書き込みます  

### 注意事項
> [!WARNING]
> 1. デジタル入力は全てINPUT_PULLUPとしています。OUTPUTに変更した場合、スイッチの押下でショートし破損しますので注意してください。  
...
Copyright (c) 2026 GraphtechKEN MIT License
